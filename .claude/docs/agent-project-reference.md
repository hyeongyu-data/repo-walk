...
│       └── skills/repo-walk/SKILL.md # Codex 전용 해설 스킬
...
| `plugins/repo-walk/` | Codex 전용 플러그인·스킬 | README 사용법, `agent-codex-plugin-reference.md` |
...
해설하며, 서버·API 키·DB·빌드가 없습니다. 새 파일·의존성을 늘리기 전에 기존
구조로 해결되는지 먼저 확인합니다. 상세 그림은 `architecture-overview.md`.
